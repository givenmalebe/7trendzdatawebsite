    ...
    extend: {
      ...
      keyframes: {
        ...
        "orb-drift-b": {
          ...
          "66%": { transform: "translate(-70px, 55px) scale(0.9)" },
        },
        "orb-drift-c": {
          "0%, 100%": { transform: "translate(0, 0) scale(1)" },
        ...
        "aurora-sweep": {
          "0%": { backgroundPosition: "-120% -80%" },
          "100%": { backgroundPosition: "220% 180%" },
        },
        "particle-drift": {
      ...
      animation: {
        ...
        "orb-drift-a": "orb-drift-a 12s ease-in-out infinite",
        "orb-drift-b": "orb-drift-b 15s ease-in-out infinite",
        "orb-drift-c": "orb-drift-c 18s ease-in-out infinite",
        "grid-pan": "grid-pan 36s linear infinite",
        "aurora-sweep": "aurora-sweep 10s linear infinite",
