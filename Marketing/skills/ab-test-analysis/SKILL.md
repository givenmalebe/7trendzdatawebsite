...
category: "CRO"
tags: ["test","analysis","ab-test-analysis","context","instructions","further-reading"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["ab-test-setup","cohort-analysis","analytics-tracking","north-star-metric"]
i18nTriggers: ["AB测试分析","A/B测试结果分析","ABテスト分析","テスト結果分析","AB테스트분석","실험결과분석","análisis de pruebas A/B"]
iconEmoji: "📈"
