...
tags: ["copy","editing","core-philosophy","the-seven-sweeps-framework","sweep-1-clarity","sweep-2-voice-and-tone"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["copywriting","page-cro","marketing-psychology","ab-test-setup"]
i18nTriggers: ["文案修改","文案润色","コピー編集","文章校正","카피편집","카피수정","edición de copy"]
iconEmoji: "✂️"
