...
tags: ["referral","program","before-starting","1-program-type","2-current-state","3-product-fit"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["launch-strategy","email-sequence","marketing-psychology","analytics-tracking"]
i18nTriggers: ["推荐计划","裂变营销","老带新","リファラルプログラム","紹介プログラム","추천프로그램","레퍼럴프로그램","programa de referidos"]
iconEmoji: "🤝"
