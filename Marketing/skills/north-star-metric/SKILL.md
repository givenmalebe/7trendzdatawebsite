...
tags: ["north","star","metric","domain-context","when-to-use","the-three-business-games"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["analytics-tracking","ab-test-analysis","cohort-analysis","growth-loops"]
i18nTriggers: ["北极星指标","核心指标","ノーススターメトリック","北極星指標","노스스타메트릭","핵심지표","métrica estrella del norte"]
iconEmoji: "⭐"
