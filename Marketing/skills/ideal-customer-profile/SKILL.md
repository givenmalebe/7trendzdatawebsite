...
tags: ["ideal","customer","profile","overview","when-to-use","icp-framework-components"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["beachhead-segment","product-marketing-context","gtm-strategy","positioning-ideas"]
i18nTriggers: ["理想客户画像","ICP分析","目标用户画像","理想顧客プロファイル","ICP分析","이상적고객프로필","ICP분석","perfil de cliente ideal"]
iconEmoji: "👤"
