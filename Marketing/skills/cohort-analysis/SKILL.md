...
tags: ["cohort","analysis","purpose","how-it-works","step-3-create-visualizations","usage-examples"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["ab-test-analysis","churn-prevention","north-star-metric","analytics-tracking"]
i18nTriggers: ["同期群分析","用户群组分析","留存分析","コホート分析","リテンション分析","코호트분석","리텐션분석","análisis de cohortes"]
iconEmoji: "📊"
