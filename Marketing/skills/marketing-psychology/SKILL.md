...
tags: ["marketing","psychology","how-to-use-this-skill","foundational-thinking-models","first-principles","jobs-to-be-done"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["page-cro","copywriting","popup-cro","ab-test-setup"]
i18nTriggers: ["营销心理学","消费者心理","マーケティング心理学","購買心理","마케팅심리학","소비자심리","psicología del marketing"]
iconEmoji: "🧠"
