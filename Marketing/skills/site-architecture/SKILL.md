...
tags: ["site","architecture","before-planning","1-business-context","2-current-state","3-site-type"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["content-strategy","programmatic-seo","seo-audit","page-cro","schema-markup","competitor-alternatives"]
i18nTriggers: ["网站架构","站点结构","URL结构","サイト設計","サイトアーキテクチャ","사이트구조","사이트설계","arquitectura web"]
iconEmoji: "🏗️"
