...
category: "Sales GTM"
tags: ["gtm","strategy","overview","when-to-use","how-it-works","step-1-gather-research-data"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["launch-strategy","gtm-motions","ideal-customer-profile","beachhead-segment","positioning-ideas"]
i18nTriggers: ["上市策略","市场推广策略","GTM戦略","市場投入戦略","GTM전략","시장출시전략","estrategia de lanzamiento al mercado"]
iconEmoji: "🗺️"
