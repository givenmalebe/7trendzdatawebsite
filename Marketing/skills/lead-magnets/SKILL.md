...
tags: ["lead","magnets","before-planning","1-business-context","2-current-lead-generation","3-content-assets"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["free-tool-strategy","copywriting","email-sequence","page-cro","popup-cro","form-cro","content-strategy","analytics-tracking","paid-ads","social-content"]
i18nTriggers: ["引流磁铁","获客资料","リードマグネット","見込み客獲得","리드마그넷","리드자석","imán de leads"]
iconEmoji: "🧲"
