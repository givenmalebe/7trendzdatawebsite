...
tags: ["value","proposition","metadata","instructions","input-requirements","value-proposition-template"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["value-prop-statements","positioning-ideas","ideal-customer-profile","product-marketing-context"]
i18nTriggers: ["价值主张设计","JTBD价值主张","バリュープロポジション設計","価値提案設計","가치제안설계","밸류프로포지션설계","diseño de propuesta de valor"]
iconEmoji: "💎"
