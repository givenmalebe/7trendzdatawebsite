...
tags: ["growth","loops","overview","when-to-use","the-5-growth-loop-types","1-viral-loop"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["referral-program","gtm-motions","north-star-metric","free-tool-strategy"]
i18nTriggers: ["增长飞轮","增长循环","グロースループ","成長の飛輪","그로스루프","성장플라이휠","bucles de crecimiento"]
iconEmoji: "🔄"
