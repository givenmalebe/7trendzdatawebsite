...
category: "Sales GTM"
tags: ["gtm","motions","overview","when-to-use","the-7-gtm-motions","1-inbound-marketing"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["gtm-strategy","ideal-customer-profile","pricing-strategy","growth-loops"]
i18nTriggers: ["GTM策略","市场进入路径","GTMモーション","GTM戦略","GTM전략","시장진입전략","movimientos de GTM"]
iconEmoji: "🎬"
