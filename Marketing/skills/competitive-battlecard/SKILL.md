...
category: "Sales GTM"
tags: ["competitive","battlecard","competitive-battlecard","context","instructions","further-reading"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["competitor-alternatives","sales-enablement","positioning-ideas","gtm-strategy"]
i18nTriggers: ["竞品对战卡","竞争分析卡片","バトルカード","競合分析カード","배틀카드","경쟁분석카드","tarjeta de batalla competitiva"]
iconEmoji: "🃏"
