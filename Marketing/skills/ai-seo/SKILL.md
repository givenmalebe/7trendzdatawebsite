...
tags: ["seo","before-starting","1-current-ai-visibility","2-content-domain","3-goals","4-competitive-landscape"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["seo-audit","schema-markup","content-strategy","competitor-alternatives","programmatic-seo","copywriting"]
i18nTriggers: ["AI搜索优化","AI搜索引擎优化","LLMO","AI検索最適化","AIサーチ対策","AI검색최적화","AI검색엔진최적화","optimización para búsqueda IA"]
iconEmoji: "🤖"
