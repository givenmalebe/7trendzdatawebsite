...
tags: ["launch","strategy","before-starting","core-philosophy","the-orb-framework","owned-channels"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["marketing-ideas","email-sequence","page-cro","marketing-psychology","programmatic-seo","sales-enablement"]
i18nTriggers: ["产品发布策略","上线策略","Product Hunt发布","プロダクトローンチ","製品発売戦略","제품런칭전략","출시전략","estrategia de lanzamiento"]
iconEmoji: "🚀"
