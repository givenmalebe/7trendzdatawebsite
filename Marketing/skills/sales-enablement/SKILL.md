...
category: "Sales GTM"
tags: ["sales","enablement","before-starting","core-principles","sales-uses-what-sales-trusts","scannable-over-comprehensive"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["competitor-alternatives","copywriting","cold-email","revops","pricing-strategy","product-marketing-context"]
i18nTriggers: ["销售赋能","销售材料","ピッチデック","営業資料作成","세일즈인에이블먼트","영업자료","habilitación de ventas"]
iconEmoji: "🎯"
