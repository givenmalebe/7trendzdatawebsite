...
tags: ["product","marketing","context","workflow","step-2-gather-information","sections-to-capture"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: []
i18nTriggers: ["产品营销背景","产品定位文档","プロダクトマーケティング","製品マーケティング","제품마케팅컨텍스트","제품포지셔닝","contexto de marketing de producto"]
iconEmoji: "🎯"
