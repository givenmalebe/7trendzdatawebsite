...
tags: ["email","sequence","initial-assessment","core-principles","1-one-email-one-job","2-value-before-ask"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["lead-magnets","churn-prevention","onboarding-cro","copywriting","ab-test-setup","popup-cro","revops"]
i18nTriggers: ["邮件序列","邮件营销自动化","EDM序列","メールシーケンス","ステップメール","이메일시퀀스","드립캠페인","secuencia de emails"]
iconEmoji: "📧"
