...
category: "Sales GTM"
tags: ["revops","before-starting","core-principles","single-source-of-truth","define-before-automate","measure-every-handoff"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["cold-email","email-sequence","pricing-strategy","analytics-tracking","launch-strategy","sales-enablement"]
i18nTriggers: ["收入运营","RevOps","线索管理","レベニューオペレーション","リード管理","레브옵스","리드관리","operaciones de ingresos"]
iconEmoji: "🔗"
