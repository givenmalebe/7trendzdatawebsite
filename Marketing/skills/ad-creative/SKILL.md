...
tags: ["creative","before-starting","1-platform-format","2-product-offer","3-audience-intent","5-constraints"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["paid-ads","copywriting","ab-test-setup","marketing-psychology","copy-editing"]
i18nTriggers: ["广告创意","广告文案生成","広告クリエイティブ","広告コピー作成","광고크리에이티브","광고카피","creatividad publicitaria"]
iconEmoji: "🎨"
