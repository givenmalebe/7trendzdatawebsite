...
category: "Sales GTM"
tags: ["cold","email","before-writing","writing-principles","one-ask-low-friction","voice-tone"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Corey Haines"
  url: "https://github.com/coreyhaines31"
relatedSlugs: ["copywriting","email-sequence","social-content","product-marketing-context","revops"]
i18nTriggers: ["开发信","冷邮件","B2B开发信","コールドメール","営業メール","콜드이메일","영업이메일","correo frío B2B"]
iconEmoji: "📨"
