...
tags: ["beachhead","segment","overview","when-to-use","key-evaluation-criteria","1-burning-pain-point"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["ideal-customer-profile","gtm-strategy","positioning-ideas","product-marketing-context"]
i18nTriggers: ["桥头堡市场","初始目标市场","ビーチヘッド市場","初期ターゲット","교두보시장","초기목표시장","segmento de mercado inicial"]
iconEmoji: "🏖️"
