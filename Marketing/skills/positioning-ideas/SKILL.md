...
tags: ["positioning","ideas","when-to-use","prompt","tips-for-best-results","further-reading"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["value-prop-statements","product-marketing-context","competitive-battlecard","copywriting"]
i18nTriggers: ["产品定位","品牌定位","ポジショニング","プロダクト差別化","포지셔닝","제품차별화","posicionamiento de producto"]
iconEmoji: "🎯"
