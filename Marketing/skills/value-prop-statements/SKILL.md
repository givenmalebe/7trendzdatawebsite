...
tags: ["value","prop","statements","when-to-use","prompt","example-framework-canva"]
compatibleModels: ["Claude","ChatGPT","Cursor"]
author:
  name: "Pawel Huryn"
  url: "https://github.com/phuryn"
relatedSlugs: ["positioning-ideas","value-proposition","copywriting","product-marketing-context"]
i18nTriggers: ["价值主张文案","价值陈述","バリュープロポジション文","価値提案文","가치제안문구","밸류프로포지션","declaraciones de propuesta de valor"]
iconEmoji: "💬"
